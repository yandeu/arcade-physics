 ...
 */
const IsoTriangleWebGLRenderer = (renderer, src, camera, parentMatrix) => {
  ...
  if (src.showTop && reversed) {
    ...
    const x3 = calcMatrix.getX(0, sizeB - height)
    const y3 = calcMatrix.getY(0, sizeB - height)
...
export default IsoTriangleWebGLRenderer
